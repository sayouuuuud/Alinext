    ...
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-border/70 bg-background/80 px-4 backdrop-blur-md sm:px-6">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          className="hidden md:flex items-center gap-1.5 rounded-lg border border-border/80 bg-card px-2.5 py-1.5 text-xs font-medium text-muted-foreground transition-colors hover:border-destructive/40 hover:text-destructive"
        ...
        <a
          ...
          className="flex items-center gap-1.5 rounded-lg border border-border/80 bg-card px-3 py-1.5 text-xs font-medium text-foreground transition-all hover:bg-muted hover:border-primary/40 shadow-2xs"
        >
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-border/80 bg-card px-2.5 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-muted"
          >
          ...
          {langMenuOpen && (
            <div className="absolute top-full mt-1.5 end-0 z-50 w-36 rounded-xl border border-border bg-card p-1 shadow-lg animate-in fade-in zoom-in-95">
              {languages.map((lang) => (
                <button
                  key={lang.code}
                  type="button"
        ...
        <button
          type="button"
          onClick={toggleTheme}
          className="flex h-9 w-9 items-center justify-center rounded-lg border border-border/80 bg-card text-foreground transition-colors hover:bg-muted hover:text-primary"
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-lg border border-border/80 bg-card text-muted-foreground transition-colors hover:bg-destructive/10 hover:border-destructive/30 hover:text-destructive"
        ...
        <button
          ...
          onClick={saveAll}
          disabled={isSaving}
          className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-primary to-accent px-3.5 py-1.5 text-xs font-semibold text-primary-foreground shadow-md shadow-primary/25 transition-all hover:opacity-95 active:scale-95 disabled:opacity-50"
        >
          {isSaving ? (
            <>
          ...
          <div className="w-full max-w-md rounded-2xl border border-border bg-card p-6 shadow-2xl">
            ...
            <div className="mt-6 flex items-center justify-end gap-2.5">
              ...
              <button
                ...
                className="rounded-lg bg-destructive px-4 py-2 text-xs font-semibold text-white hover:bg-destructive/90"
              >
                تأكيد الاستعادة
              </button>
            </div>
