...
export function NotificationCenter() {
  ...
  if (error) return <div className="rounded-3xl bg-card p-8 text-sm text-muted-foreground ring-1 ring-border">{locale === 'ar' ? 'ستظهر الإشعارات هنا بعد تفعيل ملف قاعدة البيانات اليدوي.' : 'Notifications will appear after the manual database file is applied.'}</div>
